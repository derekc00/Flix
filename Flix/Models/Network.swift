...
struct Network {
    static func loadMovies(pageNumber: UInt, completionHandler: @escaping ([Movie]?, Bool?) -> Void){
        print("loading movies...")
        var movies = [Movie]()
        print("network using page \(pageNumber)")
        let url = URL(string: "https://api.themoviedb.org/3/movie/popular?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed&page=\(pageNumber)")!
...
//                }
//
                //decodes movies from "results" key of JSON Dictionary
